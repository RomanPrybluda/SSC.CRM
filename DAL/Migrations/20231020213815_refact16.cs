...
{
    /// <inheritdoc />
    public partial class refact16 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ShipId = table.Column<Guid>(type: "uniqueidentifier", nullable: false, defaultValueSql: "NEWID()"),
                    ...
                    ShipPreviousName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ShipFirstName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ShipType = table.Column<int>(type: "int", nullable: false),
                    ClassSociety = table.Column<int>(type: "int", nullable: false),
                    ...
                    ShipOwner = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ShipOperator = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ContactPersonId = table.Column<Guid>(type: "uniqueidentifier", nullable: false, defaultValueSql: "NEWID()"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Contact Person", x => x.ContactPersonId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ContractId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    AllDocsAreReady = table.Column<bool>(type: "bit", nullable: false),
                    AllDocsAreApproved = table.Column<bool>(type: "bit", nullable: false),
                    CheckersAreAssigned = table.Column<bool>(type: "bit", nullable: false),
                    DevelopersAreAssigned = table.Column<bool>(type: "bit", nullable: false),
                    ContractIsCompleted = table.Column<bool>(type: "bit", nullable: false),
                    InvoiceIsIssued = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DocumenNumber = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DocumenName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ShipName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ShipImoNumber = table.Column<int>(type: "int", nullable: false),
                    AvailabilityRequiredDocs = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Documents_Ships_ShipId",
                        column: x => x.ShipId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Contact Person_ClientId",
